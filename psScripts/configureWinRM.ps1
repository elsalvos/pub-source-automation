...
echo $hostname >> c:\packages\hostname.txt
$makeCertPath = Get-ChildItem c:\packages\makecert.exe -Recurse | select *
echo $makeCertPath.DirectoryName >> C:\Packages\hostname.txt
#################################################################################################################################
#                                             Helper Functions                                                                  #
#################################################################################################################################
...
function Create-Certificate
{
    ...
    $serial = Get-Random
    #.\makecert 
    pushd $makeCertPath.DirectoryName
    dir *.exe
    ...
    echo $thumbprint >> C:\Packages\hostname.txt
    popd
    if(-not $thumbprint)
    {
